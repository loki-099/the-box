...
const SlideMenu = ( {isOpen, setOpen} ) => {
  ...
  return (
    <div className={`bg-black fixed transition-all duration-500 top-0 bottom-0 ${sliding} w-[50%] before:fixed before:transition-opacity before:duration-300 before:top-0 before:opacity-0 ${before} before:right-0 before:left-0 before:bg-black before:-z-10 `}>
